				 ...
				 <!-- Mulai Form -->
					<form action="add.php" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="telepon" id="inputTelepon" placeholder="Telepon" required="required">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="alamat" id="inputAlamat" placeholder="Alamat Anda" required="required">
							</div>
						</div>
						<!-- End Textarea -->
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="email" id="inputEmail" placeholder="example : youremail@email.com" required="required">
							</div>
						</div>
