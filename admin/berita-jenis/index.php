  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light">Berita Jenis</a>
             ...
             <table class="table">
              ...
              <tbody>
                ...
                <?php
                  ...
                  $penuliss = mysqli_query($koneksi, 'SELECT * from berita_jenis');
                  $no = 1;
