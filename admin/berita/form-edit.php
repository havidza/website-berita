        ...
        <div class="row">
          <div class="col-md">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control" name="waktu_terbit" value="<?php echo $row['waktu_terbit']; ?>">
              </div>
            </div>
             ...
             <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea name="isi" id="mytextarea" class="form-control" alue="<?php echo $row['isi']; ?>"></textarea>
              </div>
            </div>
