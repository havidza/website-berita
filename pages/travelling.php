			...
			<div class="col-md-8">
				...
				<nav aria-label="breadcrumb" style="background-color: #ffffff ; ">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Travelling, <?php echo date('l, d-m-y'); ?></li>
					</ol>
				</nav>
				...
				<div class="berita">
					...
					<!-- Mengambil data berita dari database table berita -->

						<?php 

						$beritas 	= mysqli_query($koneksi, 'SELECT * FROM berita where berita_jenis_id=2');
					...
					<h1 style="color: #0099CC; "><?php echo $berita['judul'] ?></h1>
