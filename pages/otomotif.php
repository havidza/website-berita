			...
			<div class="col-md-8">
				...
				<nav aria-label="breadcrumb" style="background-color: #ffffff ; ">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Otomotif , <?php echo date('l, d-m-y'); ?></li>
					</ol>
				</nav>
				...
				<div class="berita">
					<?php 
						...
						$beritas 	= mysqli_query($koneksi, 'SELECT * FROM berita where berita_jenis_id=4');
			...
			<div class="col-md-4">
				<div class="berita2">
					<div class="isiBerita">
						...
						<a href="politik.php"><button type="button" class="btn btn-outline-info">Read More</button></a>
						<br><br>
						...
						<a href="travelling.php"><button type="button" class="btn btn-outline-info">Read
								More</button></a><br><br>
